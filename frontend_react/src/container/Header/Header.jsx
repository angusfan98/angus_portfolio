...
const Header = () => {
  return (
    <div className='app__header app__flex'>
      <motion.div whileInView={{x:[-300,0], opacity:[0,1]}} transition={{duration:3}} className='app__header-info'>
        <div className='app__header-badge'>
          <div className='badge-cmp app_flex'>
            <div style={{marginLeft:0}}>
              <p className='p-text'>👋 Hello, my name is Angus Fan</p> 
            </div>
          </div>
      ...
      <motion.div whileInView={{opacity:[0,1]}} transition={{duration:0.5,delayChildren: 0.5}} className='app__header-img'>
        <img src={images.profile_picture} alt="profile_bg"></img>
